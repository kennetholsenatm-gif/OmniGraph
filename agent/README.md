...
The control plane must be started with **`--enable-sync-ws-api`** (and authentication) for the route to exist. See **`omnigraph serve --help`** in [docs/cli-and-ci.md](../docs/cli-and-ci.md).
